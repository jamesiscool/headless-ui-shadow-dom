...
// build/_snowpack/pkg/@headlessui/react.js
function _extends() {
...
function useId() {
  ...
  var _useState = react.useState(ready ? generateId : null), id3 = _useState[0], setId = _useState[1];
  useIsoMorphicEffect(function() {
    if (id3 === null)
      setId(generateId());
  }, [id3]);
  return id3 != null ? "" + id3 : void 0;
}
...
function useComputed(cb2, dependencies) {
  var _useState = react.useState(cb2), value = _useState[0], setValue = _useState[1];
...
var Button = /* @__PURE__ */ forwardRefWithAs(function Button2(props, ref) {
  ...
  var id3 = "headlessui-listbox-button-" + useId();
  ...
  var labelledby = useComputed(function() {
    if (!state2.labelRef.current)
      return void 0;
    return [state2.labelRef.current.id, id3].join(" ");
  }, [state2.labelRef.current, id3]);
  var slot = react.useMemo(function() {
    return {
...
function Label(props) {
  ...
  var id3 = "headlessui-listbox-label-" + useId();
...
var Options = /* @__PURE__ */ forwardRefWithAs(function Options2(props, ref) {
  ...
  var id3 = "headlessui-listbox-options-" + useId();
  var d = useDisposables();
...
function Option(props) {
  ...
  var id3 = "headlessui-listbox-option-" + useId();
  var active = state2.activeOptionIndex !== null ? state2.options[state2.activeOptionIndex].id === id3 : false;
  ...
  useIsoMorphicEffect(function() {
    ...
    bag.current.textValue = (_document$getElementB = document.getElementById(id3)) == null ? void 0 : (_document$getElementB2 = _document$getElementB.textContent) == null ? void 0 : _document$getElementB2.toLowerCase();
  }, [bag, id3]);
  ...
  useIsoMorphicEffect(function() {
    ...
    (_document$getElementB3 = document.getElementById(id3)) == null ? void 0 : _document$getElementB3.focus == null ? void 0 : _document$getElementB3.focus();
  }, [state2.listboxState]);
  useIsoMorphicEffect(function() {
    if (state2.listboxState !== ListboxStates.Open)
      return;
    ...
    d.nextFrame(function() {
      ...
      return (_document$getElementB4 = document.getElementById(id3)) == null ? void 0 : _document$getElementB4.scrollIntoView == null ? void 0 : _document$getElementB4.scrollIntoView({
        block: "nearest"
      });
    });
    return d.dispose;
  }, [id3, active, state2.listboxState]);
  var handleClick = react.useCallback(function(event) {
    if (disabled)
      return event.preventDefault();
    select();
...
function TransitionChild(props) {
  ...
  useIsoMorphicEffect(function() {
    ...
    match(state2, (_match2 = {}, _match2[TreeStates.Hidden] = function() {
      return unregister(id3);
    }, _match2[TreeStates.Visible] = function() {
      return register(id3);
    }, _match2));
  }, [state2, id3, register, unregister, show, strategy]);
  ...
  }, [events, id3, isTransitioning, unregister, nesting, container, skip, show, enterClasses, enterFromClasses, enterToClasses, leaveClasses, leaveFromClasses, leaveToClasses]);
  var propsWeControl = {
    ref: container
  };
...
// build/_snowpack/pkg/@heroicons/react/solid.js
...
var SelectorIcon_1 = SelectorIcon;
...
function App() {
  ...
  return /* @__PURE__ */ react.createElement("div", {
  ...
  }, /* @__PURE__ */ react.createElement(SelectorIcon$1, {
  ...
  }, people.map((person, personIdx) => /* @__PURE__ */ react.createElement(Listbox.Option, {
    key: personIdx,
    ...
    className: `${selected2 ? "font-medium" : "font-normal"} block truncate`
  }, person.name), selected2 ? /* @__PURE__ */ react.createElement("span", {
...
react_dom_default.render(/* @__PURE__ */ react.createElement(react.StrictMode, null, /* @__PURE__ */ react.createElement(App, null)), mountingPoint);
if (void 0) {
  (void 0).accept();
}
